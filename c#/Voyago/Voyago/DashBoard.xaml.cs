...
namespace Voyago
{
    public partial class DashBoard : Window
    {
        ...
        private void SaveUserSettings()
        {
            try
            {
                // Ne pas enregistrer le userEmail ici
        ...
        {
            DashBoard dashBoardAdmin = new DashBoard(userEmail);
            dashBoardAdmin.Show();
            this.Close();
        }
        ...
        {
            UserNameTextBlock.Text = $"Bienvenue, {userEmail}";  // Juste l'afficher, ne pas le sauvegarder
        }
