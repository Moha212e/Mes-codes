...
public final class Controller implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (command) {
            ...
            case ControllerActions.SHOW_CAR_DETAILS:
                if (e.getSource() instanceof javax.swing.JComponent) {
                    javax.swing.JComponent source = (javax.swing.JComponent) e.getSource();
            ...
            case ControllerActions.CLOSE_DETAILS:
                // Cette action sera gérée par la vue
                break;
            default:
     ...
     * Cette méthode évite le cast direct et la vérification de type
     */
    private void loadModelData() {
        // Appeler une méthode générique pour charger les données
        // Cette approche est plus abstraite et respecte mieux le principe OCP
        try {
            // Utiliser la réflexion pour appeler la méthode loadData si elle existe
            Method loadDataMethod = model.getClass().getMethod("loadData");
            loadDataMethod.invoke(model);
        } catch (Exception e) {
            // La méthode n'existe pas ou ne peut pas être appelée, ce n'est pas grave
