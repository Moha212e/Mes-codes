...
public interface ViewLocation {
    ...
    /**
     * Récupère le texte de recherche pour les voitures
     * @return Le texte de recherche saisi dans le champ de recherche des voitures
     */
    String getCarSearchText();
    
    /**
     * Récupère le texte de recherche pour les clients
     * @return Le texte de recherche saisi dans le champ de recherche des clients
     */
    String getClientSearchText();
    
    /**
     * Récupère le texte de recherche pour les réservations
     * @return Le texte de recherche saisi dans le champ de recherche des réservations
     */
    String getLocationSearchText();
    
    /**
     * Récupère le texte de recherche pour les contrats
     * @return Le texte de recherche saisi dans le champ de recherche des contrats
     */
    String getContratSearchText();
}
