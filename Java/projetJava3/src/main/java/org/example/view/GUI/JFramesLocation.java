...
public class JFramesLocation extends JFrame implements ViewLocation {
    ...
    private JButton buttonSortCarsByBrand, buttonSortCarsByPrice, buttonSortCarsByYear;
    private JButton buttonSortClientsByName, buttonSortClientsByBirthdate;
    private JButton buttonSortLocationsByDate, buttonSortLocationsByPrice;
    private JButton buttonSortContratsByDate, buttonSortContratsByPrice;
    ...
    private JTextField searchCarField, searchClientField, searchLocationField, searchContratField, searchCarTableField;
    private JButton searchCarButton, searchClientButton, searchLocationButton, searchContratButton;
    ...
    public JFramesLocation() {
        ...
        // Appliquer le thème FlatLaf par défaut
        setupFlatLaf("light");
        ...
        topPanel.setBackground(UIManager.getColor("Actions.Blue"));
        ...
        sessionButton = createFlatButton("Se connecter", "login", Color.BLACK);
        ...
        JMenuItem intelliJThemeItem = new JMenuItem("Thème IntelliJ");
        intelliJThemeItem.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        intelliJThemeItem.addActionListener(e -> changeTheme("intellij"));

        JMenuItem darkFlatThemeItem = new JMenuItem("Thème Flat Sombre");
        darkFlatThemeItem.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        darkFlatThemeItem.addActionListener(e -> changeTheme("darkFlat"));

        themeMenu.add(lightThemeItem);
        themeMenu.add(darkThemeItem);
        themeMenu.add(intelliJThemeItem);
        themeMenu.add(darkFlatThemeItem);
        ...
        buttonAddCar = createFlatButton("", "add" , Color.BLACK);
        buttonAddCar.setActionCommand(ControllerActions.ADD_CAR);
        buttonModifyCar = createFlatButton("", "edit", Color.BLACK);
        buttonModifyCar.setActionCommand(ControllerActions.MODIFY_CAR);
        buttonDeleteCar = createFlatButton("", "delete", Color.BLACK);
        buttonDeleteCar.setActionCommand(ControllerActions.DELETE_CAR);

        // Boutons de tri pour les voitures
        buttonSortCarsByBrand = createFlatButton("Tri par marque", "sort", Color.BLACK);
        buttonSortCarsByBrand.setActionCommand("SORT_CARS_BY_BRAND");
        buttonSortCarsByPrice = createFlatButton("Tri par prix", "sort", Color.BLACK);
        buttonSortCarsByPrice.setActionCommand("SORT_CARS_BY_PRICE");
        buttonSortCarsByYear = createFlatButton("Tri par année", "sort", Color.BLACK);
        buttonSortCarsByYear.setActionCommand("SORT_CARS_BY_YEAR");

        // Barre de recherche pour les voitures
        JPanel searchPanel1 = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        searchPanel1.setOpaque(false);
        searchCarField = new JTextField(15);
        searchCarField.setToolTipText("Rechercher une voiture par marque ou modèle");
        searchCarButton = createFlatButton("Rechercher", "search", Color.BLACK);
        searchCarButton.setActionCommand("SEARCH_CARS");
        searchPanel1.add(new JLabel("Rechercher: "));
        searchPanel1.add(searchCarField);
        searchPanel1.add(searchCarButton);

        JPanel topPanel1 = new JPanel(new BorderLayout());
        topPanel1.setOpaque(false);
        topPanel1.add(buttonPanel1, BorderLayout.WEST);
        topPanel1.add(searchPanel1, BorderLayout.EAST);
        ...
        buttonPanel1.add(buttonSortCarsByBrand);
        buttonPanel1.add(buttonSortCarsByPrice);
        buttonPanel1.add(buttonSortCarsByYear);
        ...
        buttonAddClient = createFlatButton("", "add", Color.BLACK);
        buttonAddClient.setActionCommand(ControllerActions.ADD_CLIENT);
        buttonModifyClient = createFlatButton("", "edit", Color.BLACK);
        buttonModifyClient.setActionCommand(ControllerActions.MODIFY_CLIENT);
        buttonDeleteClient = createFlatButton("", "delete", Color.BLACK);
        buttonDeleteClient.setActionCommand(ControllerActions.DELETE_CLIENT);

        // Boutons de tri pour les clients
        buttonSortClientsByName = createFlatButton("Tri par nom", "sort", Color.BLACK);
        buttonSortClientsByName.setActionCommand("SORT_CLIENTS_BY_NAME");
        buttonSortClientsByBirthdate = createFlatButton("Tri par date de naissance", "sort", Color.BLACK);
        buttonSortClientsByBirthdate.setActionCommand("SORT_CLIENTS_BY_BIRTHDATE");

        // Barre de recherche pour les clients
        JPanel searchPanel2 = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        searchPanel2.setOpaque(false);
        searchClientField = new JTextField(15);
        searchClientField.setToolTipText("Rechercher un client par nom ou prénom");
        searchClientButton = createFlatButton("Rechercher", "search", Color.BLACK);
        searchClientButton.setActionCommand("SEARCH_CLIENTS");
        searchPanel2.add(new JLabel("Rechercher: "));
        searchPanel2.add(searchClientField);
        searchPanel2.add(searchClientButton);

        JPanel topPanel2 = new JPanel(new BorderLayout());
        topPanel2.setOpaque(false);
        topPanel2.add(buttonPanel2, BorderLayout.WEST);
        topPanel2.add(searchPanel2, BorderLayout.EAST);

        buttonPanel2.add(buttonAddClient);
        buttonPanel2.add(buttonModifyClient);
        buttonPanel2.add(buttonDeleteClient);
        buttonPanel2.add(new JSeparator(SwingConstants.VERTICAL));
        buttonPanel2.add(buttonSortClientsByName);
        buttonPanel2.add(buttonSortClientsByBirthdate);
        panel2.add(topPanel2, BorderLayout.NORTH);
        panel2.add(scrollPane2, BorderLayout.CENTER);

        // Onglet 3: Lister Locations
        ...
        buttonAddLocation = createFlatButton("", "add", Color.BLACK);
        buttonAddLocation.setActionCommand(ControllerActions.ADD_LOCATION);
        buttonModifyLocation = createFlatButton("", "edit", Color.BLACK);
        buttonModifyLocation.setActionCommand(ControllerActions.MODIFY_LOCATION);
        buttonDeleteLocation = createFlatButton("", "delete", Color.BLACK);
        buttonDeleteLocation.setActionCommand(ControllerActions.DELETE_LOCATION);

        // Boutons de tri pour les réservations
        buttonSortLocationsByDate = createFlatButton("Tri par date", "sort", Color.BLACK);
        buttonSortLocationsByDate.setActionCommand("SORT_LOCATIONS_BY_DATE");
        buttonSortLocationsByPrice = createFlatButton("Tri par prix", "sort", Color.BLACK);
        buttonSortLocationsByPrice.setActionCommand("SORT_LOCATIONS_BY_PRICE");

        // Barre de recherche pour les réservations
        JPanel searchPanel3 = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        searchPanel3.setOpaque(false);
        searchLocationField = new JTextField(15);
        searchLocationField.setToolTipText("Rechercher une réservation par nom de client ou immatriculation");
        searchLocationButton = createFlatButton("Rechercher", "search", Color.BLACK);
        searchLocationButton.setActionCommand("SEARCH_LOCATIONS");
        searchPanel3.add(new JLabel("Rechercher: "));
        searchPanel3.add(searchLocationField);
        searchPanel3.add(searchLocationButton);

        JPanel topPanel3 = new JPanel(new BorderLayout());
        topPanel3.setOpaque(false);
        topPanel3.add(buttonPanel3, BorderLayout.WEST);
        topPanel3.add(searchPanel3, BorderLayout.EAST);

        buttonPanel3.add(buttonAddLocation);
        buttonPanel3.add(buttonModifyLocation);
        buttonPanel3.add(buttonDeleteLocation);
        buttonPanel3.add(new JSeparator(SwingConstants.VERTICAL));
        buttonPanel3.add(buttonSortLocationsByDate);
        buttonPanel3.add(buttonSortLocationsByPrice);
        panel3.add(topPanel3, BorderLayout.NORTH);
        panel3.add(scrollPane3, BorderLayout.CENTER);

        // Onglet 4: Lister Contrats
        panel4 = createModernPanel();
        String[] contratColumns = {"ID Contrat", "ID Réservation", "Client", "Voiture", "Caution", "Type Assurance", "Prix Assurance", "Prix Total", "Signé", "Statut"};
        ...
        buttonAddContrat = createFlatButton("", "add", Color.BLACK);
        buttonAddContrat.setActionCommand(ControllerActions.ADD_CONTRAT);
        buttonModifyContrat = createFlatButton("", "edit", Color.BLACK);
        buttonModifyContrat.setActionCommand(ControllerActions.MODIFY_CONTRAT);
        buttonDeleteContrat = createFlatButton("", "delete", Color.BLACK);
        buttonDeleteContrat.setActionCommand(ControllerActions.DELETE_CONTRAT);

        // Boutons de tri pour les contrats
        buttonSortContratsByDate = createFlatButton("Tri par date", "sort", Color.BLACK);
        buttonSortContratsByDate.setActionCommand("SORT_CONTRATS_BY_DATE");
        buttonSortContratsByPrice = createFlatButton("Tri par prix", "sort", Color.BLACK);
        buttonSortContratsByPrice.setActionCommand("SORT_CONTRATS_BY_PRICE");

        // Barre de recherche pour les contrats
        JPanel searchPanel4 = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        searchPanel4.setOpaque(false);
        searchContratField = new JTextField(15);
        searchContratField.setToolTipText("Rechercher un contrat par ID ou nom de client");
        searchContratButton = createFlatButton("Rechercher", "search", Color.BLACK);
        searchContratButton.setActionCommand("SEARCH_CONTRATS");
        searchPanel4.add(new JLabel("Rechercher: "));
        searchPanel4.add(searchContratField);
        searchPanel4.add(searchContratButton);

        JPanel topPanel4 = new JPanel(new BorderLayout());
        topPanel4.setOpaque(false);
        topPanel4.add(buttonPanel4, BorderLayout.WEST);
        topPanel4.add(searchPanel4, BorderLayout.EAST);

        buttonPanel4.add(buttonAddContrat);
        buttonPanel4.add(buttonModifyContrat);
        buttonPanel4.add(buttonDeleteContrat);
        buttonPanel4.add(new JSeparator(SwingConstants.VERTICAL));
        buttonPanel4.add(buttonSortContratsByDate);
        buttonPanel4.add(buttonSortContratsByPrice);
        panel4.add(topPanel4, BorderLayout.NORTH);
        panel4.add(scrollPane4, BorderLayout.CENTER);

        // Onglet 5: Tableau Véhicules
        panel5 = createModernPanel();
        String[] carTableColumns = {"ID Car", "Marque", "Modèle", "Année", "Prix/jour", "Kilométrages", "Carburant", "Transmission", "Places", "Disponibilité"};
        Object[][] carTableData = {};  // Les données seront ajoutées dynamiquement
        table5 = new JTable(carTableData, carTableColumns);
        stylizeTable(table5);
        JScrollPane scrollPane5 = new JScrollPane(table5);
        JPanel buttonPanel5 = new JPanel(new FlowLayout(posBouton));
        buttonPanel5.setOpaque(false);

        // Création des boutons pour l'onglet tableau véhicules
        JButton buttonAddCarTable = createFlatButton("", "add", Color.BLACK);
        buttonAddCarTable.setActionCommand(ControllerActions.ADD_CAR);
        buttonAddCarTable.addActionListener(controller);
        JButton buttonModifyCarTable = createFlatButton("", "edit", Color.BLACK);
        buttonModifyCarTable.setActionCommand(ControllerActions.MODIFY_CAR);
        buttonModifyCarTable.addActionListener(controller);
        JButton buttonDeleteCarTable = createFlatButton("", "delete", Color.BLACK);
        buttonDeleteCarTable.setActionCommand(ControllerActions.DELETE_CAR);
        buttonDeleteCarTable.addActionListener(controller);

        // Boutons de tri pour le tableau véhicules
        JButton buttonSortCarsByBrandTable = createFlatButton("Tri par marque", "sort", Color.BLACK);
        buttonSortCarsByBrandTable.setActionCommand("SORT_CARS_BY_BRAND");
        buttonSortCarsByBrandTable.addActionListener(controller);
        JButton buttonSortCarsByPriceTable = createFlatButton("Tri par prix", "sort", Color.BLACK);
        buttonSortCarsByPriceTable.setActionCommand("SORT_CARS_BY_PRICE");
        buttonSortCarsByPriceTable.addActionListener(controller);
        JButton buttonSortCarsByYearTable = createFlatButton("Tri par année", "sort", Color.BLACK);
        buttonSortCarsByYearTable.setActionCommand("SORT_CARS_BY_YEAR");
        buttonSortCarsByYearTable.addActionListener(controller);

        // Barre de recherche pour le tableau véhicules
        JPanel searchPanel5 = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        searchPanel5.setOpaque(false);
        searchCarTableField = new JTextField(15);
        searchCarTableField.setToolTipText("Rechercher une voiture par marque ou modèle");
        JButton searchCarTableButton = createFlatButton("Rechercher", "search", Color.BLACK);
        searchCarTableButton.setActionCommand("SEARCH_CARS");
        searchCarTableButton.addActionListener(controller);
        searchPanel5.add(new JLabel("Rechercher: "));
        searchPanel5.add(searchCarTableField);
        searchPanel5.add(searchCarTableButton);

        JPanel topPanel5 = new JPanel(new BorderLayout());
        topPanel5.setOpaque(false);
        topPanel5.add(buttonPanel5, BorderLayout.WEST);
        topPanel5.add(searchPanel5, BorderLayout.EAST);

        buttonPanel5.add(buttonAddCarTable);
        buttonPanel5.add(buttonModifyCarTable);
        buttonPanel5.add(buttonDeleteCarTable);
        buttonPanel5.add(new JSeparator(SwingConstants.VERTICAL));
        buttonPanel5.add(buttonSortCarsByBrandTable);
        buttonPanel5.add(buttonSortCarsByPriceTable);
        buttonPanel5.add(buttonSortCarsByYearTable);
        panel5.add(topPanel5, BorderLayout.NORTH);
        panel5.add(scrollPane5, BorderLayout.CENTER);

        // Ajout des onglets
        tabbedPane.addTab("Galerie Véhicules", panel1);
        tabbedPane.addTab("Tableau Véhicules", panel5);
        tabbedPane.addTab("Lister Clients", panel2);
        tabbedPane.addTab("Lister Locations", panel3);
        tabbedPane.addTab("Lister Contrats", panel4);
    ...
    private void setupEventListeners() {
        ...
        buttonAddCar.addActionListener(e -> {
            Car newCar = promptAddCar();
            if (newCar != null && controller != null) {
                controller.addCar(newCar);
            }
        });
    
        buttonModifyCar.addActionListener(e -> {
            Car selectedCar = getSelectedCar();
            if (selectedCar != null && controller != null) {
                showModifyCarFormFromController(selectedCar);
            } else {
                showMessage("Veuillez sélectionner un véhicule à modifier");
            }
        });
    
        buttonDeleteCar.addActionListener(e -> {
            Car selectedCar = getSelectedCar();
            if (selectedCar != null && controller != null) {
                controller.deleteCar(selectedCar);
            } else {
                showMessage("Veuillez sélectionner un véhicule à supprimer");
            }
        });
        // ... autres listeners
    }
    */
    ...
    public void updateCarTable(List<Car> cars) {
        ...
        String[] columns = {"ID Car", "Marque", "Modèle", "Année", "Prix/jour", "Kilométrages", "Carburant", "Transmission", "Places", "Disponibilité"};
        ...
        table5.getColumnModel().getColumn(0).setPreferredWidth(80);  // ID Car
        table5.getColumnModel().getColumn(1).setPreferredWidth(150); // Marque
        table5.getColumnModel().getColumn(2).setPreferredWidth(150); // Modèle
        table5.getColumnModel().getColumn(3).setPreferredWidth(60);  // Année
        table5.getColumnModel().getColumn(4).setPreferredWidth(80);  // Prix/jour
        table5.getColumnModel().getColumn(5).setPreferredWidth(100); // Kilométrages
        table5.getColumnModel().getColumn(6).setPreferredWidth(100); // Carburant
        table5.getColumnModel().getColumn(7).setPreferredWidth(100); // Transmission
        table5.getColumnModel().getColumn(8).setPreferredWidth(60);  // Places
        table5.getColumnModel().getColumn(9).setPreferredWidth(100); // Disponibilité

        // Appliquer le style à la table
        stylizeTable(table5);
        
        // Mettre à jour les images des voitures dans l'onglet Galerie Véhicules
    ...
    public Car getSelectedCar() {
        // Vérifier d'abord si une voiture est sélectionnée dans la table5 (tableau véhicules)
        int selectedRow = table5.getSelectedRow();
        if (selectedRow >= 0) {
            try {
                String idCar = table5.getValueAt(selectedRow, 0).toString();
                String brand = table5.getValueAt(selectedRow, 1).toString();
                String model = table5.getValueAt(selectedRow, 2).toString();
                int year = Integer.parseInt(table5.getValueAt(selectedRow, 3).toString());

                // Extraction du prix numérique de la chaîne (en supprimant "€/jour")
                String priceString = table5.getValueAt(selectedRow, 4).toString();
                float priceday;
                ...
                // Extraction du kilométrage (en supprimant " km")
                String mileageString = table5.getValueAt(selectedRow, 5).toString();
                int mileage = 0;
                if (mileageString.contains("km")) {
                    mileageString = mileageString.replace("km", "").trim();
                    mileage = Integer.parseInt(mileageString);
                } else if (!mileageString.isEmpty()) {
                    mileage = Integer.parseInt(mileageString);
                }

                String fuelType = table5.getValueAt(selectedRow, 6).toString();
                String transmission = table5.getValueAt(selectedRow, 7).toString();
                int seats = Integer.parseInt(table5.getValueAt(selectedRow, 8).toString());

                // Conversion de la disponibilité en booléen
                boolean available = table5.getValueAt(selectedRow, 9).toString().equals("Disponible");
                ...
                System.out.println("Erreur lors de la récupération de la voiture sélectionnée dans la table5: " + e.getMessage());
                e.printStackTrace();
            }
        }

        // Si aucune voiture n'est sélectionnée dans la table5, vérifier la table1
    ...
    // Méthode pour créer un bouton avec le style FlatLaf
    private JButton createFlatButton(String text, String iconName, Color black) {
        JButton button = new JButton(text);
        button.putClientProperty("JButton.buttonType", "roundRect");
        button.putClientProperty("JButton.arc", 12);
        button.setFont(new Font("Segoe UI", Font.BOLD, 16));

        // Utiliser les couleurs du thème FlatLaf
        button.putClientProperty("JButton.backgroundColor", UIManager.getColor("Actions.Blue"));
        button.putClientProperty("JButton.hoverBackground", UIManager.getColor("Actions.Blue").darker());
        button.putClientProperty("JButton.pressedBackground", UIManager.getColor("Actions.Blue").darker().darker());
        button.setForeground(Color.WHITE);
        button.setBackground(UIManager.getColor("Actions.Blue"));
    ...
    private void stylizeTable(JTable table) {
        ...
        table.getTableHeader().setBackground(new Color(52, 73, 94)); // Dark slate blue
    ...
    // Méthode pour configurer le thème FlatLaf
    private void setupFlatLaf(String themeName) {
        try {
            switch (themeName) {
                case "light":
                    FlatLightLaf.setup();
            ...
            // Personnalisation globale des composants
            UIManager.put("Table.showHorizontalLines", true);
            UIManager.put("Table.showVerticalLines", true);
            UIManager.put("Table.rowHeight", 28);
            UIManager.put("Table.cellFocusColor", new Color(0, 0, 0, 0)); // Transparent
     ...
     * @param themeName Le nom du thème à appliquer ("light", "dark", "intellij" ou "darkFlat")
     */
    private void changeTheme(String themeName) {
        setupFlatLaf(themeName);
        SwingUtilities.updateComponentTreeUI(this);
        ...
        JOptionPane.showMessageDialog(this,
                "Le thème " + getThemeDisplayName(themeName) + " a été appliqué avec succès.",
    ...
    private String getThemeDisplayName(String themeName) {
        switch (themeName) {
            ...
            case "darkFlat": return "Flat Sombre";
    ...
    /**
     * Met à jour les images des voitures dans l'onglet Véhicule
     * @param cars La liste des voitures
     */
    @Override
    public void updateCarImages(List<Car> cars) {
        ...
        for (Car car : cars) {
            // Vérifier si le fichier image est bien une image (jpg, jpeg, png, gif)
            String imagePath = car.getImage();
            boolean isImage = false;
            if (imagePath != null && !imagePath.isEmpty()) {
                String lower = imagePath.toLowerCase();
                isImage = lower.endsWith(".jpg") || lower.endsWith(".jpeg") || lower.endsWith(".png") || lower.endsWith(".gif");
            }
            if (!isImage) continue; // On saute si ce n'est pas une image
    ...
    public void clearAllTables() {
        try {
            ...
            String[] carColumns = {"ID Car", "Marque", "Modèle", "Année", "Prix/jour", "Kilométrages", "Carburant", "Transmission", "Places", "Disponibilité"};
    ...
    // Méthode pour obtenir le texte de recherche pour les voitures
    public String getCarSearchText() {
        // Vérifier quel onglet est actif pour utiliser le bon champ de recherche
        int selectedIndex = tabbedPane.getSelectedIndex();
        if (selectedIndex == 0) { // Galerie Véhicules
            return searchCarField.getText();
        } else if (selectedIndex == 1) { // Tableau Véhicules
            return searchCarTableField.getText();
        } else {
            // Par défaut, utiliser le champ de recherche de la galerie
            return searchCarField.getText();
        }
    }

    // Méthode pour obtenir le texte de recherche pour les clients
    public String getClientSearchText() {
        return searchClientField.getText();
    }

    // Méthode pour obtenir le texte de recherche pour les réservations
    public String getLocationSearchText() {
        return searchLocationField.getText();
    }

    // Méthode pour obtenir le texte de recherche pour les contrats
    public String getContratSearchText() {
        return searchContratField.getText();
    }
}
